...
const modules: Module[] = [
  { id: 1, title: 'Data Purification', path: '/pages/IntroStory', icon: '📊', position: 2, isRight: false, yOffset: 120 },
  { id: 2, title: 'Pattern Discovery', path: '/pages/EdaIntro', icon: '📈', position: 6, isRight: true, yOffset: 220 },
  { id: 3, title: 'Mission 1: Data Rescue', path: '/modules/game-module1/intro', icon: '🎮', position: 2, isRight: false, yOffset: 320 },
  { id: 4, title: 'Future Forecasting', path: '/module3/regression', icon: '📉', position: 6, isRight: true, yOffset: 420 },
  { id: 5, title: 'Mission 2: Shadow Tracking', path: '/modules/game-module2/regression', icon: '🎮', position: 2, isRight: false, yOffset: 520 },
  { id: 6, title: 'Truth Identification', path: '/modules/logistic-regression', icon: '🔍', position: 6, isRight: true, yOffset: 620 },
  { id: 7, title: 'Mission 3: Final Countermeasure', path: '/module3/intro', icon: '🎮', position: 2, isRight: false, yOffset: 720 },
];
...
const LearningPath: FC = () => {
  ...
  return (
    <Container>
      ...
      >
        <span className="text-[#ff6b00]">Neural Grid:</span> Riley's Mission Path
      </PageTitle>
      ...
      >
        <p className="text-yellow-400 italic">
          "The path is clear now. Each skill connects to the next, forming a neural grid of knowledge I'll need to navigate.
      ...
      <ModuleGrid>
        ...
        {modules.map((module) => (
          <ModuleCard
            ...
            onClick={() => handleModuleClick(module.id, !isModuleUnlocked(module.id))}
          />
        ))}
      </ModuleGrid>
    </Container>
