...
//       ["Mission Completed", "Hours Played"],
//       ["Mission Completed", "Money Spent ($)"],
//       ["Neural Link Stability (%)", "Sync Stability (%)"],
//       ["Quest Exploit Score", "Mission Completed"],
//     ];
...
//         {/* Heatmap Display */}
//         <div className="max-w-6xl mx-auto px-12 mb-8">
//           <div className="h-[950px] bg-[#0A2533] rounded-lg border border-[#66c0f4]/20 flex items-center justify-center p-8 shadow-lg shadow-[#66c0f4]/10">
//             {heatmapGenerated ? (
//               <img
//                 src={heatmapImage}
...
//               setClicked(true);
//               setTimeout(
//                 () => navigate("/modules/game-module1/randomforest"),
//                 500
//               );
//             }}
//             whileTap={{ scale: 0.9 }}
