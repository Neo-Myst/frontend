  ...
  return (
    <div className="w-full md:w-1/2 p-12 space-y-8 bg-black text-white relative">
      ...
      <div className="flex justify-between items-center text-lg text-gray-400 italic">
        <span>| The Digital Crime Scene: <span className="underline">Understanding Raw Data</span></span>
      ...
      <h2 className="text-xl md:text-2xl font-bold text-white leading-relaxed">
        ...
        <span className="text-yellow-400"> teach you everything you need to know</span> about data preprocessing.
      ...
      <p className="text-lg md:text-xl leading-relaxed text-gray-300">
        Riley logs into the NeoVerse servers and is greeted with a chaotic mess of data:
      </p>
      ...
      <p className="text-lg md:text-xl leading-relaxed text-gray-300">
        This is your raw dataset. In machine learning, raw data is often messy, incomplete, and unstructured.
        Your first task is to understand what you’re working with.
      </p>
