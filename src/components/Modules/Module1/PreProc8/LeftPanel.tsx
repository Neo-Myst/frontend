  ...
  return (
    <div className="w-full md:w-1/2 p-12 space-y-8 bg-black text-white relative">
      ...
      <h2 className="text-xl md:text-2xl font-bold text-white leading-relaxed">
        ...
        <span className="text-yellow-400">too many features</span>—some of which
        are
        ...
        <span className="text-yellow-400">“birth year”</span>, which convey the
        same information.
      </h2>
      ...
      <p className="text-lg md:text-xl leading-relaxed text-gray-300">
        Dimensionality reduction simplifies the dataset by removing redundant or
        irrelevant features. Common techniques include:
      </p>

      <ul className="list-disc pl-6 text-lg md:text-xl text-gray-300 space-y-2">
        <li>Principal Component Analysis (PCA).</li>
        <li>Feature selection (e.g., removing highly correlated features).</li>
      </ul>
