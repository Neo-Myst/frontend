  ...
  return (
    <div className="w-full md:w-1/2 p-12 space-y-8 bg-black text-white relative">
      ...
      <h2 className="text-xl md:text-2xl font-bold text-white leading-relaxed">
        ...
        <span className="text-yellow-400">way off</span>—like a player suddenly
        spending
        <span className="text-yellow-400">$1 million in NeoVerse coins</span>.
        These <span className="text-yellow-400">outliers</span> could skew the
        analysis and lead to
      ...
      <p className="text-lg md:text-xl leading-relaxed text-gray-300">
        ...
        of the data. You can handle them by:
      </p>
