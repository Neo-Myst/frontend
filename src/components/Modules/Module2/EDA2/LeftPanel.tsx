...
const LeftPanel: React.FC = () => {
  ...
  const correlationData = [
    {
      feature1: "Hours Played",
      feature2: "Money Spent",
      correlation: 0.78,
      insight: "Players who spend more time in-game tend to spend more money.",
    },
    {
      feature1: "Hours Played",
      feature2: "Quest Exploit Score",
      correlation: 0.56,
      insight: "More playtime moderately increases quest completion rates.",
    },
    {
      feature1: "Hours Played",
      feature2: "Neural Link Stability",
      correlation: -0.32,
      insight: "Longer play sessions slightly decrease neural link stability.",
    },
    {
      feature1: "Money Spent",
      feature2: "Quest Exploit Score",
      correlation: 0.45,
      insight: "Spending has some positive effect on quest completion.",
    },
    {
      feature1: "Quest Exploit Score",
      feature2: "Neural Link Stability",
      correlation: -0.68,
      insight:
        "Higher quest activity strongly correlates with reduced stability.",
    },
  ];
  ...
  return (
    <div className="w-full md:w-1/2 p-12 bg-black text-white relative flex flex-col h-screen overflow-y-auto font-oxanium">
      <div className="flex-grow space-y-8">
        ...
        >
          Riley now explores the{" "}
          <span className="text-yellow-400">
            relationships between features
          </span>{" "}
          to uncover hidden patterns in the NeoMyst player data.
        </motion.h2>
        ...
        >
          ...
          >
            ...
            <p className="text-lg leading-relaxed text-gray-300">
              Riley generates a correlation heatmap to visualize relationships
              between features. The heatmap reveals a strong positive
              correlation (0.78) between Hours Played and Money Spent, while
              Neural Link Stability shows negative correlations with other
              metrics, especially Quest Exploit Score (-0.68).
            </p>
                  ...
                  <div className="relative group">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center p-4 rounded-lg">
                      <p className="text-white text-sm">
                        Click on the heatmap to explore specific correlations
                      </p>
                    </div>
                  </div>
                  <p className="text-sm text-gray-400 mt-2 italic">
                    Figure 1: Correlation heatmap showing relationships between
                    NeoMyst game features
                  </p>
                </div>
      ...
      >
        <div className="p-4 bg-gray-900/50 rounded-lg border border-gray-800 mb-6">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-300">
            <li>
              Strong correlation (0.78) between Hours Played and Money Spent
              shows engagement drives monetization
            </li>
            <li>
              Significant negative correlation (-0.68) between Quest Exploit
              Score and Neural Link Stability indicates technical challenges
            </li>
            <li>
              Moderate correlation (0.56) between Hours Played and Quest Exploit
              Score shows active players complete more quests
            </li>
            <li>
              The heatmap reveals that gameplay, spending, and technical
              stability are interconnected systems
            </li>
          </ul>
        </div>
